...
<xsl:stylesheet
      ...
      <body class="ph3 pb3 mid-gray">
        <header class="mw8 pv4 center">
          <div class="flex items-center">
            <h1 class="ma0 mr2 f2 red">Sitemap</h1>
            <xsl:if test="sitemap:sitemapindex">
              <span class="dib mr2 ph3 pv1 f6 normal mid-gray bg-light-red br-pill">Index</span>
            </xsl:if>
            <xsl:if test="sitemap:urlset/sitemap:url/image:image">
              <span class="dib mr2 ph3 pv1 f6 normal mid-gray bg-light-red br-pill">Images</span>
            </xsl:if>
            <xsl:if test="sitemap:urlset/sitemap:url/video:video">
              <span class="dib mr2 ph3 pv1 f6 normal mid-gray bg-light-red br-pill">Video</span>
            </xsl:if>
            <xsl:if test="sitemap:urlset/sitemap:url/xhtml:link">
              <span class="dib mr2 ph3 pv1 f6 normal mid-gray bg-light-red br-pill">Xhtml</span>
            </xsl:if>
          </div>
          <h2 class="ma0 mt4 f4 normal">
            <xsl:choose>
              <xsl:when test="sitemap:sitemapindex">
                This index contains
                <strong class="red"><xsl:value-of select="count(sitemap:sitemapindex/sitemap:sitemap)"/></strong>
                sitemaps.
              </xsl:when>
              <xsl:otherwise>
                This index contains
                <strong class="red"><xsl:value-of select="count(sitemap:urlset/sitemap:url)"/></strong>
                URLs.
              </xsl:otherwise>
            </xsl:choose>
          </h2>
          <p>
            ...
            You can find more information about XML sitemaps on <a href="https://sitemaps.org" class="link red">sitemaps.org</a>.
          </p>
        </header>
  ...
  <xsl:template match="xhtml:link">
    ...
    <p>
      <strong>Xhtml: </strong>
      <a href="{$altloc}" class="mr2 link red">
        <xsl:value-of select="@href"/>
      </a>
