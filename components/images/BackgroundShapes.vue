<template>
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 200 200">
    <path class="fill-blue-50 dark:fill-gray-800" d="M24 200 200 25v175H24Z" />
    <path
      class="fill-blue-300 dark:fill-gray-600"
      d="m188.2 10-97.6 97.6-.3 41.9 98.2-98-.3-41.5Z"
    />
    <path
      class="fill-blue-700 dark:fill-gray-400"
      d="m149.4 38.2-43 43 .2 22.6 65.2-65.4-22.4-.2Z"
    />
    <path
      class="fill-blue-300 dark:fill-gray-600"
    ...
    <path
      class="fill-blue-300 dark:fill-gray-600"
      d="m166.4 120.3 33.5-33V61.9l-61.4 58.5h28ZM93.8 171l-29 29h17.4l29.5-29h-18Z"
    />
  </svg>
</template>
