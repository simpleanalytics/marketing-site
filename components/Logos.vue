<template>
  ...
  >
    ...
    >
      <a :href="company.url" target="_blank" class="pointer-events-auto"
        ><component :is="company.component" :class="'h-16 ' + imageclass" /></a
    ></Tooltip>
  </div>
</template>
...
const imageclass = props.imageclass ? props.imageclass : "max-w-full";
</script>
