    ...
    <div class="flex flex-col min-h-screen">
      ...
      >
        <Head>
          ...
          <!-- Generated by opgengraph.xyz -->
          <!-- HTML Meta Tags -->
          <title>The privacy-first Google Analytics alternative - Simple Analytics</title>
          <meta name="description" content="Simple Analytics is the privacy-first Google Analytics alternative that is 100% GDPR compliant. Give us a try!">

          <!-- Facebook Meta Tags -->
          <meta property="og:url" content="https://simpleanalytics.com">
          <meta property="og:type" content="website">
          <meta property="og:title" content="The privacy-first Google Analytics alternative - Simple Analytics">
          <meta property="og:description" content="Simple Analytics is the privacy-first Google Analytics alternative that is 100% GDPR compliant. Give us a try!">
          <meta property="og:image" content="https://assets.simpleanalytics.com/social-media/dark-chart.png">

          <!-- Twitter Meta Tags -->
          <meta name="twitter:card" content="summary_large_image">
          <meta property="twitter:domain" content="simpleanalytics.com">
          <meta property="twitter:url" content="https://simpleanalytics.com">
          <meta name="twitter:title" content="The privacy-first Google Analytics alternative - Simple Analytics">
          <meta name="twitter:description" content="Simple Analytics is the privacy-first Google Analytics alternative that is 100% GDPR compliant. Give us a try!">
